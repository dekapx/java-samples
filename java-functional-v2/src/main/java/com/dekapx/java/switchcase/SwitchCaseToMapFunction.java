...
public class SwitchCaseToMapFunction {
    ...
    private static BiFunction<Integer, Integer, Integer> subtraction = (a, b) -> a - b;
    private static BiFunction<Integer, Integer, Integer> multiplication = (a, b) -> a * b;
    private static BiFunction<Integer, Integer, Integer> division = (a, b) -> a / b;
